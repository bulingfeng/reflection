...
1. 主动的边界
   ...
   ```txt
   《把时间当做朋友》书中提到如何管理时间，按照时间分段来控制时间很多时候是无效的。有效的是如何控制我们的注意力。
   但是这次定投践行群中提到了主动边界。这个思考方式太牛逼了。我们总是再抱怨有些我们改变不了的事实，比如出生环境、智商、甚至颜值。而忘记改变自己能够改变的事情。或许改变自己能改变的事情不能使自己变成伟人或成功人事，但是那又如何，我们不是变的更好了吗？我们不应该开心吗？（我个人感觉只要自己在不断提高就会有一颗积极向上的心）
   ```
